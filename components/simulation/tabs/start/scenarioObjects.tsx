...
scenarioObjects.push({name: "Example 2 with vertical bars", filename: "./video davidrmiller/Example 2 with the vertical bars.sim", action: "startRun"});
scenarioObjects.push({name: "Example 4 (without kill)" , filename: "./video davidrmiller/Exemple 4 circle without kill.sim", 
                      action: "startRun"});
